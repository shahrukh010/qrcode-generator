...
//        String url = "https://sn.engagepoints.com";
    ...
    private static void generateColoredQRCode(String url, String iconUrl, String filePath, Color backgroundColor, Color foregroundColor) throws WriterException, IOException {
        ...
        BitMatrix matrix = writer.encode(url, BarcodeFormat.QR_CODE, 900, 900, hints);
        ...
        RoundRectangle2D.Double roundedRect = new RoundRectangle2D.Double(iconX, iconY, iconWidth, iconHeight, 20, 20);
